...
def arg_parse():
    ...
    # Directories
    parser.add_argument("--data_dir_pre_train", type=str, default="../Data_Place2/")      
    parser.add_argument("--data_dir_fine_tune", type=str, default="../Data_Challenge_new/")      
    parser.add_argument("--data_dir_test", type=str, default="../Data_Challenge2/")  
    parser.add_argument("--model_dir_pre_train", type=str, default="../pre_train_models/")  
    parser.add_argument("--model_dir_fine_tune", type=str, default="../fine_tune_models/")  
    ...
    parser.add_argument("--out_dir_info", type=str, default="../output/test")       
